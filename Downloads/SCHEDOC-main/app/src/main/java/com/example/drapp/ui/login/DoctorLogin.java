...
//        fbsignin=findViewById(R.id.login_button);
        emailsingnin=findViewById(R.id.loginB);
        emaile=findViewById(R.id.username);
...
//        progressBar=findViewById(R.id.progressBar);
        ...
        mGoogleSignInClient = GoogleSignIn.getClient(DoctorLogin.this, gso);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(DoctorLogin.this,DocRegisterActivity.class);
...
//        Toast.makeText(PatLogin.this, ""+email, Toast.LENGTH_SHORT).show();
        ...
        checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    Intent intent=new Intent(DoctorLogin.this,DocDash.class);
                    Bundle bundle=new Bundle();
                    bundle.putString("name",name);
                    bundle.putString("email",email);
                    intent.putExtras(bundle);
                    ...
                    Toast.makeText(DoctorLogin.this, "Account doesn't exist, please sign up first.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(), DocGinfo.class);
                    intent.putExtra("email", email);
                    startActivity(intent);
                }
            }
